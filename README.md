...
### 📊 Машинное обучение
**Bagging Classifier (как лучшая модель для скрининга из списка протестированных: Bagging, GBoosting, XGBoosting и его оптимизация):**
- **AUC**: 0.9056
- **Accuracy**: 75.89%
- **Recall**: 92.67% - эффективное выявление случаев склонности
...
- **Значительных гендерных различиях** в склонности к алкоголю
- **Валидности комплексного индекса** для оценки рисков
- **Эффективности ML-подхода** для скрининговых задач
